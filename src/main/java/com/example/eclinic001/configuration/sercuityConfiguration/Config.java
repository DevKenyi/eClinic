                ...
                .authorizeRequests(requests -> {
                            try {
                                requests
                                        ...
                                        .requestMatchers("/api/video/meeting/**").hasAnyRole("DOCTOR","ADMIN")
                                        .requestMatchers("/api/v1/updateStatus/**").hasRole("DOCTOR")
                                        .requestMatchers("/api/test/statusUpdate/**").hasRole(("DOCTOR"))
